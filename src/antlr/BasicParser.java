...
public class BasicParser extends Parser {
	...
	public static final int
		...
		FREE=17, COMMENT=5, INT=14, RETURN=18, SKIP=15, WS=1, COMMA=4, MOD=36, 
		OR=44, GT=37, DIV=35, NEG=46, LEN=47, IDENT=59, BOOL=11, OPEN_SQPARENTHESES=52, 
